  ...
  return (
    <div className="text-center pt-2">
      ...
      <div className="d-flex row row-cols-2 row-cols-md-4 g-4 my-3 px-5 justify-content-center custom-no-gutter-x">
        <MDBCard>
          <MDBCardImage src={product.image} alt={product.product_name} position="top" />
          <MDBCardBody>
            ...
            <div className='d-flex justify-content-center'>
              <MDBBtn className='me-1'onClick={() => addToCart(product, count)} color='warning'>Add to cart</MDBBtn>
            </div>
          </MDBCardBody>
